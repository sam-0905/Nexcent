...
const Testimonials = () => {
   ...
   <div className="flex flex-col items-center gap-3 bg-[#f5f7fa] px-6 py-10 md:flex-row md:justify-between lg:px-20">
    ...
    <div className="flex flex-col items-center gap-3 bg-[#f5f7fa] px-6 py-10 md:flex-row          md:justify-between lg:px-20">
        <div className="flex-1 mt-3 mb-3 items-center ml-5">
            <Image
        ...
        <div className="flex-1 space-y-10 m-1 py-2 mb-5 mr-4">
            <p className="text-md text-[#666] mb-8">{testimonial.company.para}</p>
            <h2 className="text-3xl font-bold text-[#4caf4f] mb-7">{testimonial.company.title}</h2>
            ...
            <Link 
            className="bg-[#4caf4f] text-white px-5 py-3 rounded"
